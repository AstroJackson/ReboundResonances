...
#lastN = len(combo)
now = datetime.now()
masslist_txt_append(simAU_masses,f'Masslists/{presentDirectory}{CLargs.date}BatchERROR.txt','simAU','a', leaveGithub = "Rebound", leaveEnd = f"{CLargs.date}/{presentDirectory}")
print(simAU_masses)
print("There are {} particles remaining.".format(sim.N))
