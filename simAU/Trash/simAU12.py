...
#lastN = len(combo)
masslist_txt_append(simAU_masses,'Masslists/test12.txt','simAU','a')
print(simAU_masses)
print("There are {} particles remaining.".format(sim.N))
saveFigs(innerFolder= "test12", distance = distance) # the folder witin the figures folder is set with the seed kwarg. Setting seed = "Tests" will
